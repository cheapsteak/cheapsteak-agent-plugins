...
- Note: when distributing via GitHub, you'll still want a repo-level README for human visitors—see Distribution and Sharing.
...
|---|---|---|
| User effort | Provides instructions each time | Automatic workflow execution |
| Clarifying questions | 15 back-and-forth messages | 2 clarifying questions only |
| API calls | 3 failed calls requiring retry | 0 failed API calls |
| Tokens consumed | 12,000 tokens | 6,000 tokens |
...
4. **Model "laziness"** — Add explicit encouragement in the skill:
